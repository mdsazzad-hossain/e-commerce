...
//                    }
    ...
    {
        $this->data['amount'] = $info['amount']; // decimal (10,2)	Mandatory - The amount which will process by SSLCommerz. It shall be decimal value (10,2). Example : 55.40. The transaction amount must be from 10.00 BDT to 500000.00 BDT
    ...
    {
        $this->data['name'] = $info['name']; // string (50)	Mandatory - Your customer name to address the customer in payment receipt email
        $this->data['email'] = $info['email']; // string (50)	Mandatory - Valid email address of your customer to send payment receipt from SSLCommerz end
        $this->data['address'] = $info['address'];// string (50)	Mandatory - Country of your customer. Not mandatory but useful if provided

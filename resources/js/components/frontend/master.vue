<template>
  <div>
    ...
    <div class="page-wrapper">
        ...
        <div class="top-notice text-white bg-dark" id="newsletter-headadd" style="display: none;">
        ...
        <main class="main">
            <div class="intro-slider-container">
                ...
                <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-2698px, 0px, 0px); transition: all 0s ease 0s; width: 10792px;"><div class="owl-item cloned" style="width: 1349px;"><div class="intro-slide" style="background-image: url(assets/images/demos/demo-13/slider/slide-3.jpg);">
                    ...
                    </div></div><div class="owl-item cloned" style="width: 1349px;"><div class="intro-slide" style="background-image: url(assets/images/demos/demo-13/slider/slide-5.jpg);">
                        <div class="container intro-content">
                            <div class="row">
                                <div class="col-auto offset-lg-3 intro-col">
                                    <h3 class="intro-subtitle">Fashion Promotions</h3>
                        ...
                        <!-- End .container intro-content -->
                    </div></div><div class="owl-item active" style="width: 1349px;"><div class="intro-slide" style="background-image: url(assets/images/demos/demo-13/slider/slide-1.png);">
                        <div class="container intro-content">
                            <div class="row">
                                <div class="col-auto offset-lg-3 intro-col">
                        ...
                        <!-- End .container intro-content -->
                    </div></div><div class="owl-item" style="width: 1349px;"><div class="intro-slide" style="background-image: url(assets/images/demos/demo-13/slider/slide-2.jpg);">
                        <div class="container intro-content">
                            <div class="row">
                                <div class="col-auto offset-lg-3 intro-col">
                        ...
                        <!-- End .container intro-content -->
                    </div></div><div class="owl-item" style="width: 1349px;"><div class="intro-slide" style="background-image: url(assets/images/demos/demo-13/slider/slide-3.jpg);">
                        <div class="container intro-content">
                            <div class="row">
                                <div class="col-auto offset-lg-3 intro-col">
                                    <h3 class="intro-subtitle">Fashion Promotions</h3>
                        ...
                        <!-- End .container intro-content -->
                    </div></div><div class="owl-item" style="width: 1349px;"><div class="intro-slide" style="background-image: url(assets/images/demos/demo-13/slider/slide-5.jpg);">
                        <div class="container intro-content">
                            <div class="row">
                                <div class="col-auto offset-lg-3 intro-col">
                                    <h3 class="intro-subtitle">Fashion Promotions</h3>
                        ...
                        <!-- End .container intro-content -->
                    </div></div><div class="owl-item cloned" style="width: 1349px;"><div class="intro-slide" style="background-image: url(assets/images/demos/demo-13/slider/slide-1.png);">
                        <div class="container intro-content">
                            <div class="row">
                                <div class="col-auto offset-lg-3 intro-col">
                                    <h3 class="intro-subtitle">Trade-In Offer</h3>
                        ...
                        <!-- End .container intro-content -->
                    </div></div><div class="owl-item cloned" style="width: 1349px;"><div class="intro-slide" style="background-image: url(assets/images/demos/demo-13/slider/slide-2.jpg);">
                        <div class="container intro-content">
                            <div class="row">
                                <div class="col-auto offset-lg-3 intro-col">
                                    <h3 class="intro-subtitle">Trevel &amp; Outdoor</h3>
            ...
            <div class="bg-light">
                <div class="container">
                    ...
                    <div class="tab-content tab-content-carousel">
                            ...
                            <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 1369px;"><div class="owl-item active" style="width: 190.5px; margin-right: 5px;"><div class="product">
                                    ...
                                    <!-- End .product-body -->
                                </div></div><div class="owl-item active" style="width: 190.5px; margin-right: 5px;"><div class="product">
                                    <figure class="product-media">
                                        <a href="product.html">
                                    ...
                                    <div class="product-body">
                                        <!-- End .product-cat -->
                                        <h3 class="product-title"><a href="product.html">Butler Stool</a></h3>
                                        <!-- End .product-title -->
                                        <div class="product-price">
                                            <span class="new-price">$251.99</span>
                                            <span class="old-price">Was $290.00</span>
                                    ...
                                    <div class="product-body">
                                        <!-- End .product-cat -->
                                        <h3 class="product-title"><a href="product.html">Can 2-Seater</a></h3>
                                        <!-- End .product-title -->
                                        <div class="product-price">
                                        ...
                                        <div class="ratings-container">
                                            ...
                                            <!-- End .ratings -->
                                            <span class="ratings-text">( 6 )</span>
                                        </div>
                                        <!-- End .rating-container -->
                                    </div>
                                    <!-- End .product-body -->
                                    ...
                                    <div class="product-body">
                                        <!-- End .product-cat -->
                                        <h3 class="product-title"><a href="product.html">Tan suede </a></h3>
                                        <!-- End .product-title -->
                                        <div class="product-price">
                                    ...
                                    <div class="product-body">
                                        <!-- End .product-cat -->
                                        <h3 class="product-title"><a href="product.html">Sony - Class L</a></h3>
                                        <!-- End .product-title -->
                                        <div class="product-price">
                                        ...
                                        <div class="ratings-container">
                                            ...
                                            <!-- End .ratings -->
                                            <span class="ratings-text">( 10 )</span>
                                        </div>
                                        <!-- End .rating-container -->
                                    </div>
                                    <!-- End .product-body -->
                                </div></div><div class="owl-item" style="width: 190.5px; margin-right: 5px;"><div class="product">
                                    <figure class="product-media">
                                        <a href="product.html">
                ...
                <div class="cat-blocks-container">
                    <div class="row">
                        <div class="col-12 col-sm-8 col-lg-4" style="margin-bottom: 10px;">
                            <a href="category-4cols.html" class="icon-box icon-box-side" style="border: 1px solid #ddd; padding-top:1rem !important; padding-bottom: 1rem !important;">
                                    <h3 class="icon-box-title" style="margin: auto;">Electronics</h3>
                                    <img style="width: 40px; margin: auto" src="assets/images/demos/demo-13/cats/1.jpg" alt="Category image">
                        ...
                        <div class="col-12 col-sm-8 col-lg-4" style="margin-bottom: 10px;">
                            <a href="category-4cols.html" class="icon-box icon-box-side" style="border: 1px solid #ddd; padding-top:1rem !important; padding-bottom: 1rem !important;">
                                    ...
                                    <img style="width: 40px; margin: auto" src="assets/images/demos/demo-13/cats/2.jpg" alt="Category image">
                                    <!-- <i class="icon-rotate-right"></i> -->
                                <!-- End .icon-box-content -->
                            </a>
                            <!-- End .icon-box -->
                        ...
                        <div class="col-12 col-sm-8 col-lg-4" style="margin-bottom: 10px;">
                            <a href="category-4cols.html" class="icon-box icon-box-side" style="border: 1px solid #ddd; padding-top:1rem !important; padding-bottom: 1rem !important;">
                                    ...
                                    <img style="width: 40px; margin: auto" src="assets/images/demos/demo-13/cats/3.jpg" alt="Category image">
                                    <!-- <i class="icon-rotate-right"></i> -->
                                <!-- End .icon-box-content -->
                            </a>
                            <!-- End .icon-box -->
                        ...
                        <div class="col-12 col-sm-8 col-lg-4" style="margin-bottom: 10px;">
                            <a href="category-4cols.html" class="icon-box icon-box-side" style="border: 1px solid #ddd; padding-top:1rem !important; padding-bottom: 1rem !important;">
                                    ...
                                    <img style="width: 40px; margin: auto" src="assets/images/demos/demo-13/cats/4.jpg" alt="Category image">
                                    <!-- <i class="icon-rotate-right"></i> -->
                                <!-- End .icon-box-content -->
                            </a>
                            <!-- End .icon-box -->
                        ...
                        <div class="col-12 col-sm-8 col-lg-4" style="margin-bottom: 10px;">
                            <a href="category-4cols.html" class="icon-box icon-box-side" style="border: 1px solid #ddd; padding-top:1rem !important; padding-bottom: 1rem !important;">
                                    ...
                                    <img style="width: 40px; margin: auto" src="assets/images/demos/demo-13/cats/5.jpg" alt="Category image">
                                    <!-- <i class="icon-rotate-right"></i> -->
                                <!-- End .icon-box-content -->
                            </a>
                            <!-- End .icon-box -->
                        ...
                        <div class="col-12 col-sm-8 col-lg-4" style="margin-bottom: 10px;">
                            <a href="category-4cols.html" class="icon-box icon-box-side" style="border: 1px solid #ddd; padding-top:1rem !important; padding-bottom: 1rem !important;">
                                    ...
                                    <img style="width: 40px; margin: auto" src="assets/images/demos/demo-13/cats/6.jpg" alt="Category image">
                                    <!-- <i class="icon-rotate-right"></i> -->
                                <!-- End .icon-box-content -->
                            </a>
                            <!-- End .icon-box -->

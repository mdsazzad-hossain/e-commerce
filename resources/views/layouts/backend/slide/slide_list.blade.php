    ...
    <div class="content-wrapper" style="min-height: 1589.56px;">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <div id="disableDiv" style="width: 35%;
                            padding: 10px;
                    ...
                    padding-image2: 0px;padding-top: 5px !important;padding-bottom:5px !important;">
                        <div class="panel-body">
                            <form id="banarUpload">
                                ...
                                <button id="submit-all" onclick="uploadBanar()" style="width: 100%;margin-bottom: 10px;"
                                    class="btn btn-primary">
                                    Submit
                                </button>
                                <button id="update-all" onclick="updateBanar()" style="width: 100%;margin-bottom: 10px;"
        ...
        window.onload = (()=>{
            $.ajax({
                ...
                success: function(response) {
                    if (response.id[0].id > 0) {
                        $("#disableDiv *").prop('disabled',true);
                    }
                }
            });
        })

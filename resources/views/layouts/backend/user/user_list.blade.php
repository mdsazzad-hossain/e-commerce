...
@section('content')
    <div class="content-wrapper" style="min-height: 1589.56px;">
        ...
        <section class="content">
            <div class="row">
                <div id="loading" class="col-3" style="margin-left: 15px;
                    padding-top: 8px;
                    height: 308px;
                    display: block;
                    color:#767676;
                ...
                <div id="editUser" class="card card-primary col-3" style="margin-left: 15px;
                    padding-top: 8px;
                    height: 100%;
                    display: none;
                    float: left;
                ...
                ">
                  ...
                  box-shadow: none;">
                    ...
                    <form role="form" id="contact-form">
                        ...
                        <button type="submit" style="width: 100%;margin-bottom: 10px;" class="btn btn-success">
                            Submit
                        </button>
                    </form>
                </div>
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                    ...
                                                    style="width: 219px;">Address</th>
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                    colspan="1" aria-label="Platform(s): activate to sort column ascending"
                                                    style="width: 204px;">Email</th>
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                    colspan="1"
                                                    aria-label="Engine version: activate to sort column ascending"
                                                    style="width: 139px;">Phone</th>
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                    colspan="1"
                                                    aria-label="Engine version: activate to sort column ascending"
                                                    style="width: 139px;">Status</th>
                                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"

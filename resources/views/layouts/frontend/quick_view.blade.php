                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="product-details product-details-sidebar">
                                        <h1 class="product-title">{{ $avatar->get_product->product_name }}</h1>
                                        <!-- End .product-title -->
                                        ...
                                        <div class="product-price">
                                            {{ $avatar->get_product->sale_price }}
                                        </div><!-- End .product-price -->

                                        <div class="product-content">
                                            <p>{{ $avatar->get_product->description }}</p>
                                        </div><!-- End .product-content -->

                                        <div class="details-filter-row details-row-size">
                                            <label>Color:{{ $avatar->get_product->color }}</label>
                                        ...
                                        <div class="details-filter-row details-row-size">
                                            ...
                                            <div class="select-custom">
                                                <select name="size" id="size" class="form-control">
                                                    <option value="{{ $avatar->get_product->size }}" selected="selected"
                                                        hidden>{{ $avatar->get_product->size }}</option>
